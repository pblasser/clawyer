...
knote linseg iprev, rnd(.5), inote, 1, inote
 ...
 istrin = (inote < irange*3/2 ? 4 : 6)
  ...
  acon      oscil       4095, knote/4, 9


  a1        tablei      acon+4096, istring


  ar        reson       a1, knote/2, 10, 1
...
instr 5
 ...
 a2 oscil kloop2*gibase*4, gibase*kloop3*6+gibase*12, int(rnd(8)+1)


 a3 oscil kloop*5000, gibase*kloop2*8+gibase*4+a2, int(rnd(8)+1)
